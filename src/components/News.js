      ...
      <>
        ...
        >
         ...
         {!this.state.loading &&this.state.articles.map((elements)=>{
          ...
          <button disabled={this.state.page>=Math.ceil(this.state.totalResults/this.props.pageSize)} type="button" className="btn btn-dark" onClick={this.handleNexClick}>Next &rarr;</button>
          </div> */}
      </>
    )
  }
